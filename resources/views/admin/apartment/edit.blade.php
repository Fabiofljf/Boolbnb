        ...
        <form action="{{ route('admin.apartment.update', $apartment->slug) }}" method="post" enctype="multipart/form-data">
            ...
            <div class="mb-4">
                ...
                <input type="text" name="title" required id="title"
                    ...
                    placeholder="Appartamento con Soffitto Affrescato Vista Mare" aria-describedby="titleHelper"
            ...
            <div class="my-3">
                ...
                <div class="my-3">
                    ...
                    <input type="text" name="address" required id="address"
                        ...
                        placeholder="Via indipendenza 13, Milano 20090" aria-describedby="addressHelper"
            ...
            <div class="row">
                @forelse($images as $image)
                    <div class="col-4 py-2">
                        <img class="img-fluid w-100" src="{{ asset('/storage/' . $image->src) }}" alt="$image->src">
                    </div>
                ...
                @empty
                    <div class="mb-3">
                        ...
                        <input type="file" class="form-control  @error('cover_image') is-invalid @enderror"
                            name="cover_image[]" value="" id="cover_image" placeholder="cover-img.jpg"
                            aria-describedby="cover_imageHelpId" multiple>
                ...
                @if (count($images) > 0)
                    <div class="row">
                        <div class="col my-3">
                            <p>
                                <button class="btn btn-primary text-white" type="button" data-bs-toggle="collapse"
                                    data-bs-target="#collapseExample" aria-expanded="false" aria-controls="collapseExample">
                                    Aggiungi immagini
                                </button>
                                <a class="btn btn-primary text-white"
                                    href="{{ route('admin.apartments.images.index', $apartment->slug) }}">
                                    Aggiorna Immagini
                                </a>
                            </p>
                                ...
                                <div class="card card-body">
                                    <div class="mb-3">
                                        ...
                                        <input type="file"
                                            ...
                                            name="cover_image[]" value="" id="cover_image"
                                            placeholder="cover-img.jpg" aria-describedby="cover_imageHelpId" multiple>
            ...
            <div class="mb-4">
                ...
                <textarea class="form-control  @error('description') is-invalid @enderror" name="description" required
                    id="description" rows="4">{{ old('description', $apartment->description) }}</textarea>
            </div>
