...
<div class="container">
    ...
    <form action="{{ route('admin.apartment.update', $apartment->id) }}" method="post" enctype="multipart/form-data">
        ...
        <div class="mb-4">
            ...
            <input type="text" name="title" required id="title" class="form-control @error('title') is-invalid @enderror" placeholder="Modifica il titolo" aria-describedby="titleHelper" value="{{ old('title', $apartment->title) }}">
        ...
        <div class="my-3">
            ...
            <div class="my-3">
                ...
                <input type="text" name="address" required id="address" class="form-control  @error('address') is-invalid @enderror" placeholder="Modifica l'indirizzo" aria-describedby="addressHelper" value="{{ old('address', $apartment->address) }}" readonly>
