...
<form action="{{route('admin.apartment.store')}}" method="post" enctype="multipart/form-data">
    ...
    <div class="mb-4">
        ...
        <input type="text" name="title" id="title" class="form-control @error('title') is-invalid @enderror" placeholder="Add a descriptive title" required aria-describedby="titleHelper" value="{{old('title')}}">
    ...
    <div class="mb-4">
        ...
        <input type="file" name="thumb" id="thumb" class="form-control  @error('thumb') is-invalid @enderror" placeholder="Add a captivating image" required aria-describedby="thumbHelper">
    ...
    <div class="mb-4">
        ...
        <input type="text" name="address" id="address" class="form-control  @error('address') is-invalid @enderror" required placeholder="Add apartment address" aria-describedby="addressHelper" value="{{old('address')}}">
    ...
    <div class="mb-4">
        ...
        <input type="number" name="rooms" id="rooms" class="form-control @error('rooms') is-invalid @enderror" placeholder="Add apartment rooms" min=0 aria-describedby="roomsHelper" value="{{old('rooms')}}">
    ...
    <div class="mb-4">
        ...
        <input type="number" name="baths" id="baths" class="form-control @error('baths') is-invalid @enderror" placeholder="Add apartment baths" min=0 aria-describedby="bedsHelper" value="{{old('baths')}}">
        <small id="bedsHelper" class="text-muted">Aggiungi il numero dei bagni dell'appartamento</small>
    </div>
    <div class="mb-4">
        <label for="beds" class="form-label">Letti</label>
        <input type="number" name="beds" id="beds" class="form-control @error('beds') is-invalid @enderror" placeholder="Add apartment beds" min=0 aria-describedby="bedsHelper" value="{{old('beds')}}">
